...
class Yard(models.Model):
    ...
    yard_size = models.IntegerField(default=0) # add validators, min max values for yard size?
    soil_type = models.CharField(max_length=20, default="Unknown")
    grass_type = models.CharField(max_length=20, default="Unknown")
    yard_group = models.ForeignKey(YardGroup, on_delete=models.SET_NULL, related_name='yards', null=True)

// Test nav to to-do page and empty list handling
...
describe("To-Do page task creation flow with single yard", () => {
    ...
    it("Checks the delete a task functionality", () => {
        ...
        cy.get("#pastTasks").should("not.exist")
    })
})
...
export default function PreferencesModal({
  // warning for overwriting existing autogenerated tasks, only regenerate if changed, check if seasonals exist before autogenerating (always generate if dates select). batch generate on backend? dont generate the same task on the same day. dont autodelete if marked as completed to keep accurate logs
  open,
  onClose,
  yardId,
  onPreferencesSaved,
  ...
  const handleSavePreferences = async () => {
    ...
    try {
      ...
      const shouldGenerateTasks = isNewYard || prefsChanged;

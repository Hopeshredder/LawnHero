    ...
    const fetchTips = async () => {
      ...
      try {
        ...
        if (tips) {
          ...
          const tipsArray = [
            { title: "Super Tip 2: Watering", content: 'Proper watering is key to a healthy, resilient lawn. Water efficiently to promote deep root growth, avoid stress, and prevent costly water bills. Overwatering can cause runoff and disease, while underwatering weakens or even kills the grass. '+tips.watering },
            { title: "Super Tip 3: Tools", content: 'Maintaining your yard efficiently starts with having the right tools. Essential tools may include a lawn mower, edger, fertilizer spreader, dethatching equipment, aerator, irrigation system, shovel, soil moisture meter, soil test kit, rain gauge, and gloves. Using the correct tools for your tasks saves time, reduces effort, and helps your yard stay healthy. '+tips.tools },
            { title: "Super Tip 4: Yard Problems", content: 'Yards can encounter common issues such as overwatering, underwatering, poor soil-to-grass matching, pests, diseases, and weeds. Being aware of these problems helps maintain a healthy lawn and prevent long-term damage. '+tips.yard_problems },
            { title: "Super Tip 5: Mowing", content: 'Regular mowing keeps your grass healthy, prevents thatch buildup, and promotes strong root growth. Avoid cutting too much at once; a good rule of thumb is no more than one-third of the grass height per mow. '+tips.mowing },
            { title: "Super Tip 6: Fertilizing", content: 'Fertilizing your lawn provides essential nutrients that promote healthy growth, vibrant color, and resilience against stress. The type and amount of fertilizer should be chosen based on your soil composition, grass type, and the season. Over-fertilizing can harm your lawn and the environment, while under-fertilizing may limit growth and color. '+tips.fertilizing },
            { title: "Super Tip 7: Aerating", content: 'Aerating your lawn helps relieve soil compaction, improves water and nutrient absorption, and promotes stronger root growth. Regular aeration enhances overall turf health and resilience. '+tips.aerating },
            { title: "Super Tip 8: Dethatching", content: 'A thick layer of thatch can block water, nutrients, and air from reaching your grass roots, reducing lawn health. Dethatching helps remove this layer, encouraging stronger growth and better nutrient absorption. '+tips.dethatching },
          ];
